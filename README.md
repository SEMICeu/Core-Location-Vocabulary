...
The current version of the Core Location Vocabulary can be downloaded from [https://semiceu.github.io/Core-Location-Vocabulary/releases/2.0.2/](https://semiceu.github.io/Core-Location-Vocabulary/releases/2.0.2/).
